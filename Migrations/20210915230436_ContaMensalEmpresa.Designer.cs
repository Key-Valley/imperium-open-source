...
namespace Fatec_Facilities.Migrations
{
    ...
    [Migration("20210915230436_ContaMensalEmpresa")]
    partial class ContaMensalEmpresa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fatec_Facilities.Models.CategoriaContaMensalEmpresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ccm_emp_id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("tab_categoria_conta_mensal_empresa");
                });
            ...
            modelBuilder.Entity("Fatec_Facilities.Models.CategoriaManutencaoPredialEmpresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("cmp_emp_id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("tab_categoria_manutencao_predial_empresa");
                });
            ...
            modelBuilder.Entity("Fatec_Facilities.Models.ContaMensalEmpresa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("con_emp_id")
                        .HasColumnType("int");

                    b.Property<int>("CategoriaContaMensalId")
                        .HasColumnName("cat_con_id")
                        .HasColumnType("int");

                    b.Property<int>("ContaMensalId")
                        .HasColumnName("con_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContaMensalId");

                    b.HasIndex("EmpresaId");

                    b.ToTable("tab_conta_mensal_empresa");
                });
            ...
            modelBuilder.Entity("Fatec_Facilities.Models.ContaMensalEmpresa", b =>
                {
                    ...
                    b.HasOne("Fatec_Facilities.Models.ContaMensal", "ContaMensal")
                        .WithMany()
                        .HasForeignKey("ContaMensalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
